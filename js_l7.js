...
const snake = {
    ...
    scoring() {
        const blockScore = document.getElementById("score");
        blockScore.innerHTML = `СЧЁТ: ${this.score}`;
    },
    ...
    getNextHeadPoint() {
        ...
        switch (this.direction) {
            case "down":
                if (firstPoint.y === config.settings.colsCount-1) {
            ...
            case "up":
                if (firstPoint.y === 0) {
                    return {x: firstPoint.x, y: config.settings.colsCount-1};
                }
                return {x: firstPoint.x, y: firstPoint.y - 1};

            case "left":
                if (firstPoint.x === 0) {
                    return {x: config.settings.rowsCount-1, y: firstPoint.y};
                }
                return {x: firstPoint.x - 1, y: firstPoint.y};

            case "right":
                if (firstPoint.x === config.settings.rowsCount-1) {
